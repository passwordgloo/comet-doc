...
## 优抚安置社会工作的特点<Badge text="必考" type="info" />

覆盖范围广、军队情结深、需要层级多、问题压力重

## 优抚医院服务对象<Badge text="必考" type="info" />
...
## 光荣院的服务对象<Badge text="了解" type="note" />

入住前的评估与准备工作

对疏于照顾问题、药物滥用与依赖问题特别关注

## 军转复转军人<Badge text="必考" type="info" />
...
## 军休服务对象<Badge text="必考" type="info" />
